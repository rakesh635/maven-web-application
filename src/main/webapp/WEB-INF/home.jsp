...
<html>
<head>
<spring:url value="/resources/images/devopslogo.jpg" var="devopslogo" />
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>MithunTechnologies- Home Page</title>
<link href="${devopslogo}" rel="icon">
</head>
</head>
<body>
<h1 align="center">Welcome to Teja Technologies.</h1>
<h1 align="center">Very Good Training center for DevOps in Bangalore started by Pruthvi Teja patnering with Bhupathi Abinash and also for Job Assitance... and Job Support also...Teaching Real Time scnerios</h1>
<hr>
<div style="text-align: center;">
	<span>
		<img src="${devopslogo}" alt="" width="100"/>
